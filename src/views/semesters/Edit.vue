...
const getData = () => {
  DepartementDataService.retrieveData("semesters", departement.id)
    .then((resp) => {
      departement.name = resp.data.nom;
      departement.filiere = resp.data.filiere;
    })
    .catch((e) => {
      alert(e);
    });
...
const submit = () => {
  ...
  DepartementDataService.updateData("semesters", data.id, data)
    .then(() => {
