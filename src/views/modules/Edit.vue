...
const getData = () => {
  DepartementDataService.retrieveData("modules", departement.id)
    .then((resp) => {
      departement.name = resp.data.nom;
      departement.groupe = resp.data.groupe;
      departement.semester = resp.data.semester;
    })
    .catch((e) => {
      alert(e);
    });
...
const submit = () => {
  ...
  DepartementDataService.updateData("modules", data.id, data)
    .then(() => {
      router.push("/modules");
    })
    .catch((e) => {
                  ...
                  <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                      ...
                      <input
                        type="text"
                        name="phone"
                        placeholder="Entrez Groupe"
                        v-model="departement.groupe"
                        id="phone"
                        autocomplete="phone"
                        class="mt-1 focus:ring-indigo-500 bg-white dark:bg-gray-900 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                      />
                     ...
                     <div class="col-span-6 sm:col-span-3">
                      ...
                      <input
                        type="text"
                        name="phone"
                        placeholder="Entrez Semester"
                        v-model="departement.semester"
                        id="phone"
                        autocomplete="phone"
                        class="mt-1 focus:ring-indigo-500 bg-white dark:bg-gray-900 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                      />
