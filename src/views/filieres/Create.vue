...
const submit = () => {
  const data = {
    ...
    departem: departement.departem,
    professeur: departement.professeur
  };
    DepartementDataService.createData("filieres", data)
    .then((response) => {
      departement.id = response.data.id;
      departement.name = response.data.name;
      departement.type = response.data.type;
      departement.departem = response.data.departem;
      departement.professeur = response.data.professeur;
