...
const getData = () => {
  DepartementDataService.retrieveData("filieres", departement.id)
    .then((resp) => {
      departement.name = resp.data.nom;
      departement.type = resp.data.type;
      departement.departem = resp.data.departem;
      departement.professeur = resp.data.professeur;
    })
    .catch((e) => {
      alert(e);
    });
...
const submit = () => {
  const data = {
    ...
    departement: departement.departem
  };
  DepartementDataService.updateData("filieres", data.id, data)
    .then(() => {
                  ...
                  <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                     ...
                     <div class="col-span-6 sm:col-span-3">
                      ...
                      <input
                        type="text"
                        name="phone"
                        placeholder="Entrez Département"
                        v-model="departement.departem"
                        id="phone"
                        autocomplete="phone"
                        class="mt-1 focus:ring-indigo-500 bg-white dark:bg-gray-900 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                      />
                    ...
                    <div class="col-span-6 sm:col-span-3">
                      ...
                      <input
                        type="text"
                        name="phone"
                        placeholder="Entrez Professeur"
                        v-model="departement.professeur"
                        id="phone"
                        autocomplete="phone"
                        class="mt-1 focus:ring-indigo-500 bg-white dark:bg-gray-900 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                      />
